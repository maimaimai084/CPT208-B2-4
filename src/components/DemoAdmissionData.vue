<template>
  <div class="space-y-8">
    <!-- Header -->
    <div class="bg-white rounded-2xl border border-[#81C1C3] p-6 shadow-sm">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
      <div class="bg-white rounded-xl border border-[#81C1C3] p-4 text-center shadow-sm">
      ...
      <div class="space-y-3">
        <div v-for="dest in overallStats.destinations" :key="dest.region" class="flex items-center gap-4">
          ...
          <div class="flex-1 h-3 bg-slate-100 rounded-full overflow-hidden">
            <div class="h-full bg-[#81C1C3] rounded-full transition-all duration-1000" :style="{ width: dest.share + '%' }"></div>
          </div>
