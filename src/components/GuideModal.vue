  ...
  <Transition name="modal">
    <div v-if="isOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div class="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[80vh] overflow-hidden">
        <div class="sticky top-0 bg-gradient-to-r from-[#E88EAF] to-[#B86281] text-white p-6">
        ...
        <div class="sticky bottom-0 bg-gray-50 p-4 border-t border-gray-200">
          <button @click="close" class="w-full py-3 bg-[#E88EAF] hover:bg-[#B86281] text-white rounded-xl font-medium transition-colors">
            Close Guide
          </button>
        </div>
      </div>
